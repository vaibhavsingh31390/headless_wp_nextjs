...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-group alignwide">
		...
		<div class="wp-block-group alignfull">
            ...
            <p class="blog-post__undertitle-item pipe-connector">|</p>
            <p class="blog-post__undertitle-item"><?php echo get_the_date( $date_format, $id); ?></p>
			<p class="blog-post__undertitle-item pipe-connector">|</p>
			<p class="blog-post__undertitle-item"><?php echo get_the_modified_date($date_format, $id); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
	</div>
